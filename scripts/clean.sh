...
echo "Warning: This script is expected to be run in the root of your fluxgit checkout like ./scripts/clean.sh with zsh. Running it in a different manner may cause unexpected file loss."
