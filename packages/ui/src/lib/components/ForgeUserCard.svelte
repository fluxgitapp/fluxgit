...
<div class="forge-user-card">
	<div class="forge-user-card__container">
		<div class="forge-user-card__icon-side">
			<div class="avatar">
				{#if isError}
					<svg
						class="icon"
...
<style lang="postcss">
	...
	.forge-user-card__container {
		display: flex;
		width: 100%;
		gap: 16px;
	}

	.forge-user-card__icon-side {
		display: flex;
	}

	.forge-user-card__content {
		display: flex;
		flex: 1;
		flex-direction: column;
		gap: 4px;
	...
	.forge-user-card__title {
		color: var(--clr-text-1);
	}

	.forge-user-card__text {
