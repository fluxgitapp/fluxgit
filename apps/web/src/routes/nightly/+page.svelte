...
<svelte:head>
	<title>FluxGit | Nightly Builds</title>
</svelte:head>
			...
			<div class="nightly-hero__header">
				...
				<div class="nightly-hero__header-labels">
					...
					<div class="nightly-hero__header-details">
						...
						<span> • </span>
						<a
							href="https://github.com/fluxgitapp/fluxgit/commit/{latestNightly.sha}"
							target="_blank"
					...
					<p class="nightly-hero__description">
						Experience FluxGit's newest features before anyone else. Nightly builds are
					...
					<div class="stack-v gap-6">
						...
						<span class="download-card-small-subtile"
							>Not working? Have a look at <a
								...
								href="https://github.com/fluxgitapp/fluxgit/blob/master/LINUX.md"
					...
					<div class="release-row__content">
						...
						<div class="release-row__info">
							...
							<div class="flex items-center gap-2">
								...
								<a
									href="https://github.com/fluxgitapp/fluxgit/commit/{release.sha}"
									target="_blank"
									rel="noopener noreferrer"
