...
<svelte:head>
	<title>FluxGit | Color Generator</title>
</svelte:head>
...
<div class="container">
	...
	<div class="about-section">
		...
		<p class="text-14 text-body clr-text-2">
			HSL-based color scale generator for the FluxGit app.
			<br />
			Copy CSS and replace it in the app settings.
			<a class="underline" href="https://docs.fluxgit.com/color-theme" target="_blank">
				Read docs</a
			> ↗ to learn more.
		</p>
