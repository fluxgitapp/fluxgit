...
describe("Install script import", () => {
	...
	it("is a bootstrap script that downloads the installer binary", () => {
		...
		expect(installScript).toContain("FluxGit installer bootstrap script");
		expect(installScript).toContain("https://app.fluxgit.com/installers/info");
		expect(installScript).toContain("https://releases.fluxgit.com");
	});
