...
This directory serves the FluxGit CLI installation script at `https://fluxgit.com/install.sh`.
...
Users can install FluxGit CLI with:

```bash
curl -sSL https://fluxgit.com/install.sh | bash
```
