<script lang="ts">
	...
	import type { NotificationSettingsService } from "@fluxgit/shared/settings/notificationSettingsService";
	import type { NotificationSettings as NotificationSettingsType } from "@fluxgit/shared/settings/types";
...
<div class="stack-v gap-8">
	...
	<p class="text-12 text-body clr-text-2">
		Manage your email notification preferences for various activities within FluxGit.
	</p>
</div>
