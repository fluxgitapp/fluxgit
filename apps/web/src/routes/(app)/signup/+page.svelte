<script lang="ts">
	...
	import { Button, EmailTextbox, InfoMessage } from "@fluxgit/ui";
	...
	{#snippet footer()}
		<div class="auth-form__footer">
			{#if !successMessage}
				<p>
					*By signing up, you agree to our
					<a href="https://fluxgit.com/terms">Terms</a>
					and
					<a href="https://fluxgit.com/privacy">Privacy Policy</a>
				</p>
				<p>
			...
			{:else}
				<p>
					Need help? <a
						href="https://github.com/fluxgitapp/fluxgit/issues/new?template=BLANK_ISSUE"
						target="_blank"
