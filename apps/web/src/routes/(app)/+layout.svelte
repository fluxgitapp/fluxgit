<script lang="ts">
	...
	import { provide } from "@fluxgit/core/context";
	import { BranchService, BRANCH_SERVICE } from "@fluxgit/shared/branches/branchService";
	import {
		LatestBranchLookupService,
		LATEST_BRANCH_LOOKUP_SERVICE,
	} from "@fluxgit/shared/branches/latestBranchLookupService";
	import {
		ChatChannelsService,
		CHAT_CHANNELS_SERVICE,
	} from "@fluxgit/shared/chat/chatChannelsService";
	import { FeedService, FEED_SERVICE } from "@fluxgit/shared/feeds/service";
	import LoginService, { LOGIN_SERVICE } from "@fluxgit/shared/login/loginService";
	import { HttpClient, HTTP_CLIENT } from "@fluxgit/shared/network/httpClient";
	import {
		OrganizationService,
		ORGANIZATION_SERVICE,
	} from "@fluxgit/shared/organizations/organizationService";
	import { ProjectService, PROJECT_SERVICE } from "@fluxgit/shared/organizations/projectService";
	import {
		RepositoryIdLookupService,
		REPOSITORY_ID_LOOKUP_SERVICE,
	} from "@fluxgit/shared/organizations/repositoryIdLookupService";
	import {
		PatchEventsService,
		PATCH_EVENTS_SERVICE,
	} from "@fluxgit/shared/patchEvents/patchEventsService";
	import {
		PatchCommitService,
		PATCH_COMMIT_SERVICE,
	} from "@fluxgit/shared/patches/patchCommitService";
	import {
		PatchIdableService,
		PATCH_IDABLE_SERVICE,
	} from "@fluxgit/shared/patches/patchIdableService";
	import { APP_STATE } from "@fluxgit/shared/redux/store.svelte";
	import { RulesService, RULES_SERVICE } from "@fluxgit/shared/rules/rulesService";
	import {
		NotificationSettingsService,
		NOTIFICATION_SETTINGS_SERVICE,
	} from "@fluxgit/shared/settings/notificationSettingsService";
	import { UploadsService, UPLOADS_SERVICE } from "@fluxgit/shared/uploads/uploadsService";
	import {
		UserService as NewUserService,
		USER_SERVICE as NEW_USER_SERVICE,
	} from "@fluxgit/shared/users/userService";
	import { ChipToastContainer } from "@fluxgit/ui";
	import {
		EXTERNAL_LINK_SERVICE,
		type ExternalLinkService,
	} from "@fluxgit/ui/utils/externalLinkService";
