<script lang="ts">
	...
	import { eventTimeStamp } from "@fluxgit/shared/branches/utils";
	...
	import { getRulesList } from "@fluxgit/shared/rules/rulesPreview.svelte";
	import { RULES_SERVICE } from "@fluxgit/shared/rules/rulesService";
	import type { Rule } from "@fluxgit/shared/rules/types";
