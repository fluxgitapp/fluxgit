<script lang="ts">
	...
	import { getBranchReviewsForRepository } from "@fluxgit/shared/branches/branchesPreview.svelte";
	import { BranchStatus } from "@fluxgit/shared/branches/types";
	import Loading from "@fluxgit/shared/network/Loading.svelte";
	import { getProject } from "@fluxgit/shared/organizations/projectsPreview.svelte";
	import { type ProjectParameters } from "@fluxgit/shared/routing/webRoutes.svelte";
	import { WEB_ROUTES_SERVICE } from "@fluxgit/shared/routing/webRoutes.svelte";
	import { Button, Select, SelectItem } from "@fluxgit/ui";
