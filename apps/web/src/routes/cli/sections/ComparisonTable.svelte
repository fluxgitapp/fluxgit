<script lang="ts">
	...
	const features = [
		{ name: "Stacked branch workflows", git: false, fluxgit: true },
		{ name: "Work on multiple branches simultaneously", git: false, fluxgit: true },
		{ name: "Unlimited undo/redo", git: false, fluxgit: true },
		{ name: "Simple, predictable rebasing", git: false, fluxgit: true },
		{ name: "Fast worktree management", git: false, fluxgit: true },
		{ name: "AI agent-friendly commands", git: false, fluxgit: true },
		{ name: "Make commits", git: true, fluxgit: true },
		{ name: "Works with Git repositories", git: true, fluxgit: true },
	];
</script>
...
<section class="comparison-wrapper">
	...
	<div class="comparison-table">
		<div class="text-16 text-bold table-header">
			...
			<div class="header-cell">FluxGit</div>
		</div>
		...
		{#each features as feature}
			<div class="table-row">
				...
				<div class="status-cell" data-label="FluxGit">
					{#if feature.fluxgit}
						<svg
							width="20"
							height="20"
	...
	<div class="comparison-description">
		<p class="text-15 text-body text-center text-balance">
			FluxGit works with your existing Git repositories and remotes.
		</p>
		<p class="text-15 text-body text-center text-balance">
