		...
		<div class="reviews-column">
			...
			<TwitterCard
				tweet={{
					...
					content:
						'You might want to follow along with @fluxgit if you are looking for something fresh',
		...
		<div class="reviews-column">
			<TwitterCard
				tweet={{
					...
					content:
						'FWIW, @fluxgit has absolutely changed my git workflow to make it easier to apply those PRs to my environment! If you’ve not seen it before then check it out',
