<script lang="ts">
	...
	import { getChatChannelParticipants } from "@fluxgit/shared/chat/chatChannelsPreview.svelte";
	import { CHAT_CHANNELS_SERVICE } from "@fluxgit/shared/chat/chatChannelsService";
	import { uploadFiles } from "@fluxgit/shared/dom";
	import { PATCH_COMMIT_SERVICE } from "@fluxgit/shared/patches/patchCommitService";
	import { APP_STATE } from "@fluxgit/shared/redux/store.svelte";
	import { UPLOADS_SERVICE } from "@fluxgit/shared/uploads/uploadsService";
	import { NEW_USER_SERVICE } from "@fluxgit/shared/users/userService";
