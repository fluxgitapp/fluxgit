<script lang="ts">
	...
	import { eventTimeStamp, getMultipleContributorNames } from "@fluxgit/shared/branches/utils";
	import { getPatchContributorsWithAvatars } from "@fluxgit/shared/contributors";
	import { isFound } from "@fluxgit/shared/network/loadable";
	import { type PatchVersionEvent } from "@fluxgit/shared/patchEvents/types";
	import { getPatch } from "@fluxgit/shared/patches/patchCommitsPreview.svelte";
	import { AvatarGroup, Icon } from "@fluxgit/ui";
