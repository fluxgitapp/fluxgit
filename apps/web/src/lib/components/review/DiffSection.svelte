<script lang="ts">
	...
	import { isLockfile } from "@fluxgit/shared/lockfiles";
	import { getFilePathInfo } from "@fluxgit/shared/utils/file";
	import { Button, FileIcon, HunkDiff } from "@fluxgit/ui";
	import type { DiffSection } from "@fluxgit/shared/patches/types";
