<script lang="ts">
	...
	import { getPatchIdableSections } from "@fluxgit/shared/patches/patchCommitsPreview.svelte";
	import { Button, Select, SelectItem, type SelectItemType } from "@fluxgit/ui";
