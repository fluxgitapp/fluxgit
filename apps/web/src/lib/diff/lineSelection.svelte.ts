import { encodeDiffFileLine } from "@fluxgit/ui/utils/diffParsing";
import type { DiffPatch } from "@fluxgit/shared/chat/types";
import type { DiffFileLineId, LineSelector } from "@fluxgit/ui/utils/diffParsing";
