...
export async function fillMeta(html: string, url: string) {
	let metaTags = `
        <!-- Meta Tags -->
        <!-- Open Graph -->
        <meta property="og:title" content="FluxGit" />
        <meta property="og:description" content="FluxGit software development platform" />
        <meta property="og:image" content="%image%" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content="${url}" />
        <meta property="og:site_name" content="FluxGit" />

        <!-- Twitter Card Meta Tags -->
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FluxGit" />
        <meta name="twitter:description" content="FluxGit software development platform" />
        <meta name="twitter:image" content="%image%" />
        <meta name="twitter:site" content="@fluxgit" />
        <!-- / Meta Tags -->
`;
