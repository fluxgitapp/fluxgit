import { deduplicateBy } from "@fluxgit/shared/utils/array";
...
import type { UserSimple } from "@fluxgit/shared/users/types";
import type { UserService } from "@fluxgit/shared/users/userService";
import type { MentionSuggestion, MentionSuggestionUpdate } from "@fluxgit/ui";
import type Mention from "@fluxgit/ui/richText/plugins/Mention.svelte";
