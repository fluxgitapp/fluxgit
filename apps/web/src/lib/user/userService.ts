...
import { apiToBranch } from "@fluxgit/shared/branches/types";
import { get, writable, type Writable } from "svelte/store";
import type { ApiBranch, Branch } from "@fluxgit/shared/branches/types";
import type { HttpClient } from "@fluxgit/shared/network/httpClient";
import type { Loadable } from "@fluxgit/shared/network/types";
