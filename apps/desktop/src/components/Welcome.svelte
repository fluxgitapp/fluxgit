...
<div class="welcome" data-testid={TestId.WelcomePage}>
	<h1 class="welcome-title text-serif-42">Welcome to FluxGit!</h1>
	...
	<div class="links">
		<div class="links__section">
			...
			<div class="education-links">
				<IconLink
					icon="docs"
					href="https://docs.fluxgit.com/features/virtual-branches/branch-lanes"
				>
					FluxGit docs
				</IconLink>
				<IconLink icon="youtube" href="https://www.youtube.com/@fluxgitapp">
					Watch tutorials
				</IconLink>
			</div>
		</div>
		<div class="links__section">
			...
			<div class="community-links">
				...
				<IconLink icon="bluesky" href="https://bsky.app/profile/fluxgit.com">Bluesky</IconLink>
				<IconLink icon="instagram" href="https://www.instagram.com/fluxgit/">Instagram</IconLink>
				<IconLink icon="youtube" href="https://www.youtube.com/@fluxgitapp">YouTube</IconLink>
			</div>
		</div>
	</div>
</div>
