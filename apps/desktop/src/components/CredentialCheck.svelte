<script lang="ts">
	...
	import { Button, Icon, InfoMessage, Link } from "@fluxgit/ui";
...
<div class="credential-check">
					...
					{#if errors > 0}
						<div class="text-12 text-body help-text" transition:slide>
							<span>
								...
								<br />
								Consult our
								<Link href="https://docs.fluxgit.com/troubleshooting/fetch-push">
									fetch / push guide
								</Link>
	...
	<SectionCardDisclaimer>
		To test the push command, we create an empty branch and promptly remove it after the check. <Link
			href="https://docs.fluxgit.com/troubleshooting/fetch-push">Read more</Link
