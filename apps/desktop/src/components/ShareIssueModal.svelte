<script lang="ts">
	...
	import { Button, Checkbox, Modal, Textarea, EmailTextbox, chipToasts } from "@fluxgit/ui";
	...
	async function submit() {
		...
		context += "FluxGit Version: " + appVersion + "\n";
...
<Modal
	bind:this={modal}
	title="Share debug data with FluxGit team for review"
	onSubmit={async () => await submit()}
>
	<div class="content-wrapper">
		<p class="content-wrapper__help-text text-13 text-body">
			If you are having trouble, please share your project and logs with the FluxGit team. We will
