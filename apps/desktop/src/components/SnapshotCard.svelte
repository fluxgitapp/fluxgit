<script lang="ts">
	...
	import { Button, Icon, ScrollableContainer, type IconName } from "@fluxgit/ui";
	...
	<div class="snapshot-right-container">
		<div class="restore-btn">
			<Button
				size="tag"
				kind="outline"
				tooltip="Restores FluxGit and your files to the state before this operation. Revert actions can also be undone."
				onclick={() => {
					onRestoreClick();
				}}
