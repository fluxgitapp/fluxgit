<script lang="ts">
	...
	import { CardGroup, Select, SelectItem } from "@fluxgit/ui";

	import type { ForgeName } from "$lib/forge/interface/forge";
	import type { Project } from "$lib/project/project";
	import type { ButGitHubToken, ButGitLabToken } from "@fluxgit/core/api";
...
<CardGroup>
	...
	{#if forge.current.name === "github"}
		<ForgeAccountConfig
			...
			docsUrl="https://docs.fluxgit.com/features/forge-integration/github-integration"
	...
	{#if forge.current.name === "gitlab"}
		<ForgeAccountConfig
			...
			docsUrl="https://docs.fluxgit.com/features/forge-integration/gitlab-integration"
