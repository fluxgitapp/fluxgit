<script lang="ts">
	...
	import { persistWithExpiration } from "@fluxgit/shared/persisted";
	...
	import { intersectionObserver } from "@fluxgit/ui/utils/intersectionObserver";
	...
	// Use the new AI chat panel when useForAgentChat is enabled and a provider is configured
	const useAIChatPanel = $derived(
		aiProviderService.settings.useForAgentChat &&
		!!aiProviderService.getActiveClient()
	);
