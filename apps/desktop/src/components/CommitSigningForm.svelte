	...
	<CardGroup>
		<CardGroup.Item labelFor="signCommits">
			...
			{#snippet caption()}
				...
				<br />
				FluxGit will sign commits as per your git configuration, but evaluates
				<code class="code-string">fluxgit.signCommits</code> with priority.
			{/snippet}
			{#snippet actions()}
		...
		<CardGroup>
			<CardGroup.Item>
				...
				<SectionCardDisclaimer>
					...
					<Link href="https://docs.fluxgit.com/features/virtual-branches/signing-commits"
						>Read more</Link
