...
{#snippet buttonText()}
	{currentEditorWidth > DROPDOWN_BTN_BREAKPOINTS.medium ? "Generate with AI" : "Generate"}
{/snippet}
...
>
	Your file will be stored in FluxGit’s digital vault, safe and sound. We promise it’s secure, so
