<script lang="ts">
	...
	import { Button, CardGroup, Spacer, Toggle } from "@fluxgit/ui";
...
<SettingsSection>
	{#snippet description()}
		FluxGit supports the use of OpenAI and Anthropic to provide commit message and branch name
		generation. This works either through FluxGit's API or in a bring your own key configuration
		...
		<CardGroup>
			<CardGroup.Item labelFor="aiExperimental">
				...
				{#snippet caption()}
					...
					requires you to use OpenAI through FluxGit in order for the features to work.
				{/snippet}
				{#snippet actions()}
					<Toggle
						id="aiExperimental"
	...
	<CardGroup>
		<CardGroup.Item>
			...
			<p class="text-12 text-body">
				You can apply your own custom prompts to the project. By default, the project uses FluxGit
