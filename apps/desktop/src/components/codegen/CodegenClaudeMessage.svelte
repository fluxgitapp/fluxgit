<script lang="ts">
	...
	import CodegenFluxGitMessage from "$components/codegen/CodegenFluxGitMessage.svelte";
	...
	import { Icon, Markdown } from "@fluxgit/ui";
...
{:else if message.source === "gitButler"}
	<CodegenFluxGitMessage {projectId} {message} />
{/if}
