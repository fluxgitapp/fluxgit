<script lang="ts">
	...
	import { Tooltip, AsyncButton, RichTextEditor, FilePlugin, UpDownPlugin } from "@fluxgit/ui";
	import { tick, type Snippet } from "svelte";
	import { fade } from "svelte/transition";
	import type { FileSuggestionUpdate } from "@fluxgit/ui/richText/plugins/FilePlugin.svelte";
