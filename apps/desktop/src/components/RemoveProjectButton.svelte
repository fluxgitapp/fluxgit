<script lang="ts">
	import { Button, Modal, TestId } from "@fluxgit/ui";
...
>
	<div class="remove-project-description">
		<p class="text-14 text-body">
			...
			<span class="text-bold">{projectTitle}</span> from FluxGit?
		</p>

		<p class="text-12 text-body details-text">
			When you delete your project from FluxGit, your repository doesn't get deleted. It just
