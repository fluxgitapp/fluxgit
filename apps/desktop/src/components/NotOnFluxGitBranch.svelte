<script lang="ts">
	...
	import { AsyncButton, RadioButton, FileListItem, Link } from "@fluxgit/ui";
		...
		<DecorativeSplitView img={directionDoubtSvg} hideDetails>
			...
			<div class="switchrepo__content">
				<p class="switchrepo__title text-18 text-body text-bold">
					You've switched away from <span class="code-string"> fluxgit/workspace </span>
				</p>

				<p class="switchrepo__message text-13 text-body">
					Due to FluxGit managing multiple virtual branches, you cannot switch back and forth
