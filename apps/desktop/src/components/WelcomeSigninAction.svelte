<script lang="ts">
	...
	import { Button, CardGroup, Textbox, Spacer } from "@fluxgit/ui";
		...
		<div class="token-content">
			...
			<div class="info-section">
				...
				<p class="text-12 text-body clr-text-2">
					Sign in to FluxGit to get your personal access token.
				</p>
				...
				<p class="text-12 text-body clr-text-2 m-t-16">
					An access token is required to use FluxGit's smart automation features, including
