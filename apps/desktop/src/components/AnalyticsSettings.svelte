<script lang="ts">
	...
	import { CardGroup, Link, TestId, Toggle } from "@fluxgit/ui";
...
<div class="analytics-settings__content">
	<p class="text-13 text-body analytics-settings__text">
		FluxGit uses telemetry strictly to help us improve the client. We do not collect any personal
		information, unless explicitly allowed below. <Link href="https://fluxgit.com/privacy">
			Privacy policy
		</Link>
	</p>
	<p class="text-13 text-body analytics-settings__text">
