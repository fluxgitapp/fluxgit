<script lang="ts">
	...
	import { isImageFile } from "@fluxgit/shared/utils/file";
	import { EmptyStatePlaceholder, generateHunkId, HunkDiff, TestId } from "@fluxgit/ui";
	import { DRAG_STATE_SERVICE } from "@fluxgit/ui/drag/dragStateService.svelte";
	import { parseHunk } from "@fluxgit/ui/utils/diffParsing";
	import type { FileDependencies } from "$lib/dependencies/dependencies";
	import type { TreeChange } from "$lib/hunks/change";
	import type { UnifiedDiff } from "$lib/hunks/diff";
	import type { LineId } from "@fluxgit/ui/utils/diffParsing";
