<script lang="ts">
	...
	import { Button, ContextMenu, ContextMenuItem, ContextMenuSection, TestId } from "@fluxgit/ui";
	...
	<div class="top">
		<div class="logo">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M12 2L2 12L12 22L22 12L12 2Z" stroke="var(--clr-theme-pop-element)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M12 6L6 12L12 18L18 12L12 6Z" fill="var(--clr-theme-pop-element)"/>
			</svg>
			<span class="logo-text text-bold">FluxGit</span>
		</div>
		<div>
			{#if isWorkspacePath()}
...
<style lang="postcss">
	...
	:global(.sidebar .btn-square.btn-active) {
		...
		/* workspace icon */
		--clr-workspace-legs: var(--clr-theme-pop-element);
		--clr-workspace-top: var(--clr-theme-pop-element);
		/* branches icon */
		--clr-branches: var(--clr-theme-pop-element);
		/* target icon */
		--clr-target-bg: var(--clr-theme-pop-element);
		--clr-target-lines: #fff;
		/* history icon */
		--clr-history-arrows: var(--clr-theme-pop-element);
		--clr-history-outline: var(--clr-theme-pop-element);
		/* settings icon */
		--clr-settings-bg: var(--clr-theme-pop-element);
		/* claude icon */
		--clr-claude-bg: var(--clr-theme-pop-element);
		/* codegen icon */
		--clr-codegen-bg: var(--clr-theme-pop-element);
