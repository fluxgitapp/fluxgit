<script lang="ts">
	...
	import { AvatarGroup, LineStats, ReviewBadge, SeriesLabelsRow, TestId, TimeAgo } from "@fluxgit/ui";
	import { gravatarUrlFromEmail } from "@fluxgit/ui/components/avatar/gravatar";
		...
		<div class="text-12 sidebar-entry__details">
			...
			{#if branchListingDetails}
				<div class="sidebar-entry__details-item">
					{#if branchListingDetails.linesAdded || branchListingDetails.linesRemoved}
						<LineStats
