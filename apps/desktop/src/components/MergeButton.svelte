<script lang="ts">
	...
	import { persisted, type Persisted } from "@fluxgit/shared/persisted";

	import { ContextMenuItem, ContextMenuSection, DropdownButton } from "@fluxgit/ui";
	import type { ButtonProps } from "@fluxgit/ui";
