...
/** Represents the outcome of an action performed by a FluxGit automation. */
export type Outcome = {
...
/** Represents a snapshot of an automatic action taken by a FluxGit automation.  */
...
/** Represents a workflow that was executed by FluxGit. */
