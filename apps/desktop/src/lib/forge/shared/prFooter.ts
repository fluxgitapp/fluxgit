...
export const STACKING_FOOTER_BOUNDARY_TOP = "<!-- FluxGit Footer Boundary Top -->";
export const STACKING_FOOTER_BOUNDARY_BOTTOM = "<!-- FluxGit Footer Boundary Bottom -->";

export const BUT_REVIEW_FOOTER_BOUNDARY_TOP = "<!-- FluxGit Review Footer Boundary Top -->";
export const BUT_REVIEW_FOOTER_BOUNDARY_BOTTOM = "<!-- FluxGit Review Footer Boundary Bottom -->";
...
function generateFooter(forPrNumber: number, allPrNumbers: number[], symbol: string) {
	...
	footer += "---\n";
	footer += `This is **part ${nth} of ${stackLength} in a stack** made with FluxGit:\n`;
