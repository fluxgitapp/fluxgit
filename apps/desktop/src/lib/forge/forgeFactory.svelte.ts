...
import { deepCompare } from "@fluxgit/shared/compare";
...
import type { Reactive } from "@fluxgit/shared/storeUtils";
...
export function availableForgeDocsLink(forge: AvailableForge): string {
	switch (forge) {
		case "github":
			return "https://docs.fluxgit.com/features/forge-integration/github-integration";
		case "gitlab":
			return "https://docs.fluxgit.com/features/forge-integration/gitlab-integration";
	}
}
