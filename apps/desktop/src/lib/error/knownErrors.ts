...
Please check our [documentation](https://docs.fluxgit.com/features/virtual-branches/signing-commits) on setting up commit signing and verification.
		`,
	[Code.RepoOwnership]: `
...
The database was changed by a more recent version of FluxGit - cannot safely open it anymore.
	`,
