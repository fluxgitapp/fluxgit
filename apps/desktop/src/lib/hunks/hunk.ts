import { memoize } from "@fluxgit/shared/memoization";
import {
	lineIdKey,
	parseHunk,
	SectionType,
	type LineId,
	type LineLock,
} from "@fluxgit/ui/utils/diffParsing";
import type { HunkLock, HunkLocks } from "$lib/dependencies/dependencies";
import type { Prettify } from "@fluxgit/shared/utils/typeUtils";
...
export function canBePartiallySelected(patch: Patch): boolean {
	...
	// See: https://github.com/fluxgitapp/fluxgit/pull/7893
