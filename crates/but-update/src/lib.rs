#![deny(missing_docs)]
//! Application update checking and management for FluxGit.
//!
//! This crate provides functionality to check for new versions of FluxGit applications
//! (CLI and GUI), cache update check results, and manage update notifications.
//!
//! # Core Functionality
//!
//! - **Update Checking**: Query the FluxGit update server for available updates
