use but_ctx::Context;
use fluxgit_operating_modes::{EditModeMetadata, write_edit_mode_metadata};
...
mod operating_modes {
    mod open_workspace_mode {
        use fluxgit_operating_modes::{ensure_open_workspace_mode, in_open_workspace_mode};
        use fluxgit_testsupport::{Case, Suite};

        use crate::create_and_checkout_branch;

        #[test]
        fn in_open_workspace_mode_true_when_in_fluxgit_workspace() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();

            create_and_checkout_branch(ctx, "fluxgit/workspace");
        ...
        #[test]
        fn in_open_workspace_mode_false_when_in_fluxgit_edit() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();

            create_and_checkout_branch(ctx, "fluxgit/edit");
        ...
        #[test]
        fn assure_open_workspace_mode_ok_when_on_fluxgit_workspace() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
        ...
        #[test]
        fn assure_open_workspace_mode_err_when_on_fluxgit_edit() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
    ...
    mod outside_workspace_mode {
        use fluxgit_operating_modes::{ensure_outside_workspace_mode, in_outside_workspace_mode};
        use fluxgit_testsupport::{Case, Suite};
        ...
        #[test]
        fn in_outside_workspace_mode_false_when_on_fluxgit_edit() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
        ...
        #[test]
        fn in_outside_workspace_mode_false_when_on_fluxgit_workspace() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
        ...
        #[test]
        fn assure_outside_workspace_mode_err_when_on_fluxgit_edit() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
        ...
        #[test]
        fn assure_outside_workspace_mode_err_when_on_fluxgit_workspace() {
            let suite = Suite::default();
            let Case { ctx, .. } = &suite.new_case();
    ...
    mod edit_mode {
        use fluxgit_operating_modes::{ensure_edit_mode, in_edit_mode};
        use fluxgit_testsupport::{Case, Suite};
