...
pub const WORKSPACE_BRANCH_REF: &str = "refs/heads/fluxgit/workspace";

/// Previous workspace reference, delete after transition.
pub const INTEGRATION_BRANCH_REF: &str = "refs/heads/fluxgit/integration";

/// To prevent clients hitting the "looks like you've moved away from..."
/// after upgrading to a version using the new fluxgit/workspace branch
...
pub const EDIT_BRANCH_REF: &str = "refs/heads/fluxgit/edit";
...
pub enum OperatingMode {
    /// The typical app state when it's on the fluxgit/workspace branch
    OpenWorkspace,
    /// When the user has chosen to leave the fluxgit/workspace branch
    OutsideWorkspace(OutsideWorkspaceMetadata),
    /// When the app is off of fluxgit/workspace and in edit mode
