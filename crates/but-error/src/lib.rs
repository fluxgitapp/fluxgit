...
///
/// In practice, it should match its [frontend counterpart](https://github.com/fluxgitapp/fluxgit/blob/fa973fd8f1ae8807621f47601803d98b8a9cf348/app/src/lib/backend/ipc.ts#L5).
