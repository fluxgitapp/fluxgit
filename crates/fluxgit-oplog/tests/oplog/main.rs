mod trailer {
    // use fluxgit_core::ops::entry::Trailer;
    use std::str::FromStr;

    use fluxgit_oplog::entry::Trailer;
...
mod version {
    ...
    use fluxgit_oplog::entry::{Trailer, Version};
...
mod operation_kind {
    ...
    use fluxgit_oplog::entry::{OperationKind, SnapshotDetails, Trailer, Version};
...
mod snapshot_details {
    ...
    use fluxgit_oplog::entry::{OperationKind, Snapshot, SnapshotDetails, Trailer, Version};
