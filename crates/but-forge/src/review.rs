...
pub const STACKING_FOOTER_BOUNDARY_TOP: &str = "<!-- FluxGit Footer Boundary Top -->";
pub const STACKING_FOOTER_BOUNDARY_BOTTOM: &str = "<!-- FluxGit Footer Boundary Bottom -->";
...
fn generate_footer(for_pr_number: i64, all_pr_numbers: &[i64], symbol: &str) -> String {
    ...
    footer.push_str(&format!(
        "This is **part {nth} of {stack_length} in a stack** made with FluxGit:\n"
    ));
