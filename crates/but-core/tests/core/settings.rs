    ...
    fn set_git_settings() -> anyhow::Result<()> {
        ...
        assert_eq!(
            ...
            GitConfigSettings {
                ...
                ..GitConfigSettings {
                    fluxgit_gerrit_mode: Some(false),
                    ..Default::default()
                }
            },
        ...
        let expected = GitConfigSettings {
            fluxgit_sign_commits: Some(true),
            fluxgit_gerrit_mode: Some(false),
            fluxgit_forge_review_template_path: None,
            fluxgit_gitlab_project_id: None,
            fluxgit_gitlab_upstream_project_id: None,
