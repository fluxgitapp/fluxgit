...
/// i.e. `refs/heads/fluxgit/workspaces/<name>`.
...
impl StackId {
    ...
    ///
    /// Single branch mode happens when no `fluxgit/workspace` reference is checked out,
...
pub struct Review {
    ...
    /// A handle to the review created with the FluxGit review system.
