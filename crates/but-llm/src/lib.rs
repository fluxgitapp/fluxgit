...
const MODEL_PROVIDER: &str = "fluxgit.aiModelProvider";
...
impl LLMProvider {
    ...
    /// specifically looking for the `fluxgit.aiModelProvider` setting to determine
    ...
    /// - The `fluxgit.aiModelProvider` setting is not present
