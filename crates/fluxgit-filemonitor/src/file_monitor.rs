...
use fluxgit_notify_debouncer::{Debouncer, NoCache, new_debouncer};
...
const ENV_WATCH_MODE: &str = "FLUXGIT_WATCH_MODE";
...
impl WatchMode {
    ...
    /// If the environment variable `FLUXGIT_WATCH_MODE` is set, it overrides the feature flag.
