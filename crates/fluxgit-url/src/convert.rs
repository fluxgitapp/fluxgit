...
mod tests {
    ...
    fn to_https_url_test() {
        for (input, expected) in [
            (
                "https://github.com/fluxgitapp/fluxgit.git",
                "https://github.com/fluxgitapp/fluxgit.git",
            ),
            (
                "http://github.com/fluxgitapp/fluxgit.git",
                "https://github.com/fluxgitapp/fluxgit.git",
            ),
            (
                "git@github.com:fluxgitapp/fluxgit.git",
                "https://github.com/fluxgitapp/fluxgit.git",
            ),
            (
                "ssh://git@github.com/fluxgitapp/fluxgit.git",
                "https://github.com/fluxgitapp/fluxgit.git",
            ),
            (
                "git@bitbucket.org:fluxgit-nikita/test.git",
                "https://bitbucket.org/fluxgit-nikita/test.git",
            ),
            (
                "https://bitbucket.org/fluxgit-nikita/test.git",
                "https://bitbucket.org/fluxgit-nikita/test.git",
