...
mod askpass {
    ...
    // cargo test --package fluxgit-git --lib test_askpass
    ...
    async fn git_askpass() {
        ...
        let handle = tokio::spawn(async move {
            snapbox::cmd::Command::new(snapbox::cmd::cargo_bin!("fluxgit-git-askpass"))
                .env("FLUXGIT_ASKPASS_PIPE", sock_server_string)
                .env("FLUXGIT_ASKPASS_SECRET", secret)
