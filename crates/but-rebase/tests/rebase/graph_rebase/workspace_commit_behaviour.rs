...
fn workspace_remains_unchanged_with_no_operations() -> Result<()> {
    ...
    * 8600a31 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * 2b9cba3 (main, c) c
    * 8df3400 (b) b
    * 5b128a2 (a) a
    * 3b506ba (base) base
    ...
    let id = repo.rev_parse_single("fluxgit/workspace")?;
...
fn workspace_commit_is_not_signed_after_cherry_pick() -> Result<()> {
    ...
    * 04c2142 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * f5d7b3a (main, c) c
    * 5b128a2 (b, a) a
    * 3b506ba (base) base
    ");

    insta::assert_snapshot!(cat_commit(&repo, "fluxgit/workspace")?, @"
...
fn workspace_commit_should_not_be_allowed_to_conflict() -> Result<()> {
    ...
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @"
    * f7f22fe (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * 734fb4e (main, c) c
    * 17ac6d7 (b) b
    * d8d3a16 (a) a
    * b1b6109 (base) base
