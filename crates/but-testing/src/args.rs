...
#[clap(name = "fluxgit-cli", about = "A CLI for FluxGit", version = option_env!("GIX_VERSION"))]
pub struct Args {
    ...
    #[clap(short = 'a', long, env = "FLUXGIT_CLI_DATA_DIR")]
...
pub enum Subcommands {
    ...
    /// Add the given Git repository as project for use with FluxGit.
    AddProject {
    ...
    Watch {
        ...
        #[clap(long, short = 'm', value_parser = ["legacy", "modern", "auto"], env = "FLUXGIT_WATCH_MODE")]
        mode: Option<String>,
    },
    WatchDb,
    ...
    /// Returns the list of stacks that are currently part of the FluxGit workspace.
    Stacks {
