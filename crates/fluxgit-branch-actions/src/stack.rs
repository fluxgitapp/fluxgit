...
use fluxgit_operating_modes::ensure_open_workspace_mode;
use fluxgit_oplog::{
    OplogExt, SnapshotExt,
    entry::{OperationKind, SnapshotDetails},
};
use fluxgit_reference::normalize_branch_name;
use fluxgit_repo::hooks;
use fluxgit_repo_actions::RepoActionsExt;
use fluxgit_stack::{PatchReferenceUpdate, StackBranch, StackId};
