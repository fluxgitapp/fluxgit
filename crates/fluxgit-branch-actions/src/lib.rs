//! FluxGit internal library containing functionality related to branches, i.e. the virtual branches implementation
mod actions;
// This is our API
pub use actions::{
...
mod integration;
pub use integration::{FLUXGIT_WORKSPACE_COMMIT_TITLE, update_workspace_commit};
