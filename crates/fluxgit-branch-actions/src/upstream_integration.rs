...
use fluxgit_commit::commit_ext::CommitExt as _;
use fluxgit_repo::{
    RepositoryExt as _,
    logging::{LogUntil, RepositoryExt as _},
    rebase::fluxgit_merge_commits,
};
use fluxgit_stack::{StackId, Target, VirtualBranchesHandle};
use fluxgit_workspace::branch_trees::{WorkspaceState, update_uncommitted_changes};
...
pub fn upstream_integration_statuses(
    ...
    let workdir_tree = context
        ...
        .git2_repo
        .get()?
        .create_wd_tree(fluxgit_project::AUTO_TRACK_LIMIT_BYTES)?
        .id()
        .to_gix();
...
pub(crate) fn resolve_upstream_integration(
    ...
    match resolution_approach {
        ...
        BaseBranchResolutionApproach::Merge => {
            ...
            let new_head = fluxgit_merge_commits(
                repo,
                old_target,
