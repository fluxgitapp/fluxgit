...
set_change_id() {
    ...
    local change_id_key="fluxgit-change-id"
    local fluxgit_header_version_key="fluxgit-headers-version"
    local fluxgit_header_version_value="2"
...

    {
        ...
        echo "$fluxgit_header_version_key $fluxgit_header_version_value"
