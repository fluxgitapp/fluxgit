...
mod tests {
    ...
    use fluxgit_repo::hooks::{ErrorData, HookResult, MessageData, MessageHookResult};
...
";
        ...
        assert_eq!(
            fluxgit_repo::hooks::post_commit(ctx)?,
...
";
        ...
        assert_eq!(
            fluxgit_repo::hooks::commit_msg(ctx, message)?,
...
";
    ...
    fn husky_hooks_disabled_even_if_present() -> anyhow::Result<()> {
        ...
        assert_eq!(
            fluxgit_repo::hooks::commit_msg(ctx, "commit message".to_owned())?,
