use fluxgit_branch_actions::BranchListingDetails;
...
mod util {
    ...
    use fluxgit_branch_actions::{Author, BranchListingDetails};
    ...
    pub fn branch_details(
        ...
        let mut details = fluxgit_branch_actions::get_branch_listing_details(ctx, branch_names)?;
    ...
    pub fn project_ctx(name: &str) -> anyhow::Result<Context> {
        fluxgit_testsupport::read_only::fixture("for-details.sh", name)
    }
}
