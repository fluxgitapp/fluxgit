...
use fluxgit_branch_actions::FLUXGIT_WORKSPACE_COMMIT_TITLE;
use fluxgit_oplog::{OplogExt, SnapshotExt};
use fluxgit_project::{self as projects, ProjectId};
use fluxgit_stack::StackId;
use fluxgit_testsupport::{TestProject, VAR_NO_CLEANUP, paths};
...
impl Test {
    pub fn new_with_settings(change_settings: fn(&mut AppSettings)) -> Self {
        ...
        let outcome =
            fluxgit_project::add_at_app_data_dir(data_dir.as_ref(), test_project.path())
