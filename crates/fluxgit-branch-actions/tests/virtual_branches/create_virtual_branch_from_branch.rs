...
use fluxgit_reference::LocalRefname;
...
fn no_conflicts() {
    ...
    let branch_id = fluxgit_branch_actions::create_virtual_branch_from_branch(
        ctx,
...
fn conflicts_with_uncommited() {
    ...
    // create a local branch that conflicts with remote
    {
        ...
        let mut guard = ctx.exclusive_worktree_access();
        let _stack_entry = fluxgit_branch_actions::create_virtual_branch(
            ctx,
    ...
    let new_branch_id = fluxgit_branch_actions::create_virtual_branch_from_branch(
        ctx,
        &"refs/remotes/origin/branch".parse().unwrap(),
        None,
        None,
...
fn from_default_target() {
    ...
    assert_eq!(
        fluxgit_branch_actions::create_virtual_branch_from_branch(
            ctx,
            &"refs/remotes/origin/master".parse().unwrap(),
            None,
            None,
...
fn from_state_remote_branch() {
    ...
    let _ = fluxgit_branch_actions::create_virtual_branch_from_branch(
        ctx,
        &"refs/remotes/origin/branch".parse().unwrap(),
        None,
        None,
