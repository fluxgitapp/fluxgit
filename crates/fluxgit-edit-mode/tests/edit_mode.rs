...
use fluxgit_edit_mode::commands::{
...
fn command_ctx(folder: &str) -> Result<(Context, TempDir)> {
    fluxgit_testsupport::writable::fixture("edit_mode.sh", folder)
}

// Fixture:
// * xxx (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
// * xxx foobar
// | * 1e2a3a8 (right) right
// |/
// | * f3d2634 (left) left
