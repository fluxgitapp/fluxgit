...
mod from_new_merge_with_metadata {
    ...
    fn without_conflict_journey() -> anyhow::Result<()> {
        ...
        * 85efbe4 (main, fluxgit/workspace) M
        ...
        author FluxGit <fluxgit@fluxgit.com> 946771200 +0000
        committer FluxGit <fluxgit@fluxgit.com> 946771200 +0000
        encoding UTF-8

        FluxGit Workspace Commit
        ...
        If you switch to another branch, FluxGit will need to be reinitialized.
        If you commit on this branch, FluxGit will throw it away.

        Here are the branches that are currently applied:
         - add-A
           branch head: d3cce74a69ee3b0e1cbea65b53908d602d6bda26
        For more information about what we're doing here, check out our docs:
        https://docs.fluxgit.com/features/branch-management/integration-branch
        ");
    ...
    fn with_conflict_commits() -> anyhow::Result<()> {
        ...
        insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
        * 8450331 (HEAD -> main, tag: conflicted) FluxGit WIP Commit
        * a047f81 (tag: normal) init
        ...
        insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
        * 8450331 (tag: conflicted, tip-conflicted) FluxGit WIP Commit
        ...
        * a047f81 (tag: normal, main) init
        ...
        graph = graph.redo_traversal_with_overlay(
            ...
            Overlay::default().with_references_if_new([
                ...
                gix::refs::Reference {
                    name: "refs/heads/fluxgit/workspace".try_into()?,
