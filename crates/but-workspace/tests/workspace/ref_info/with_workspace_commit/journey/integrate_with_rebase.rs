...
fn two_commits_rebased_onto_target() -> anyhow::Result<()> {
    ...
    * 946cdb7 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
...
fn two_commits_rebased_onto_target_one_amended_afterwards() -> anyhow::Result<()> {
    ...
    ");
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * 4c3a992 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
...
fn two_rewritten_commits_track_as_local_and_remote() -> anyhow::Result<()> {
    ...
    ");
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * 0b1ed50 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * e9c9d74 (A) A2
    * 550b6ac A1
    | * ad92cce (origin/A) A2
    | * e1f216e A1
...
fn two_commits_rebased_onto_target_with_changeset_check() -> anyhow::Result<()> {
    ...
    ");
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * f1caa51 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * f9c2b14 (origin/A, A) A2
    * e1f216e A1
