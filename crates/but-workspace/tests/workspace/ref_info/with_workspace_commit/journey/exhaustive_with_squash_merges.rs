...
fn j06_create_commit_in_stack() -> anyhow::Result<()> {
    ...
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * 9a8283b (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * ba16348 (S1) one
    * fafd9d0 (origin/main, main) init
    ");
...
fn j08_next_local_commit() -> anyhow::Result<()> {
    ...
    ");
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * 9e1f264 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * 9f4d478 (S1) two
...
fn j09_rewritten_remote_and_local_commit() -> anyhow::Result<()> {
    ...
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    * 4d23090 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    * 314cacb (S1) two
...
fn j12_local_only_multi_segment_squash_merge() -> anyhow::Result<()> {
    ...
    ");
    insta::assert_snapshot!(visualize_commit_graph_all(&repo)?, @r"
    *   4da5b24 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    |\  
