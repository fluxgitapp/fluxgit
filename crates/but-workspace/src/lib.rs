...
//! * **Stack**
//!   - FluxGit implements the concept of a branch stack. This is essentially a collection of "heads"
//!     (pseudo branches) that contain each other.
//!   - Always contains at least one branch.
//!   - High level documentation here: <https://docs.fluxgit.com/features/branch-management/stacked-branches>
//! * **Target Branch**
...
/// **Do not use!**
/// A module with code that depends on `fluxgit-` crates. As such, it's supposed to be ported or rewritten.
...
pub struct RefInfo {
    ...
    /// The `workspace_ref_name` is `Some(_)` and belongs to FluxGit, because it had metadata attached.
