...
pub struct UpdateRequest {
    ...
    pub unset_api: bool,
    pub fluxgit_data_last_fetched: Option<FetchResult>,
...
impl UpdateRequest {
    ...
    pub fn default_with_id(id: ProjectId) -> Self {
        Self {
            ...
            api: None,
            unset_api: false,
            fluxgit_data_last_fetched: None,
            preferred_key: None,
...
impl From<Project> for UpdateRequest {
    fn from(
        Project {
            ...
            husky_hooks_enabled,
            api,
            fluxgit_data_last_fetch,
            fluxgit_code_push_state,
        ...
        UpdateRequest {
            ...
            api,
            unset_api: false,
            fluxgit_data_last_fetched: fluxgit_data_last_fetch,
...
impl Storage {
    ...
    pub fn update(
        ...
        if let Some(fluxgit_data_last_fetched) = fluxgit_data_last_fetched.as_ref() {
            project.fluxgit_data_last_fetch = Some(fluxgit_data_last_fetched.clone());
        }
        ...
        if let Some(state) = fluxgit_code_push_state {
            project.fluxgit_code_push_state = Some(state);
        }
