mod fluxgit_merge_commits {
    use fluxgit_repo::rebase::fluxgit_merge_commits;
    use fluxgit_testsupport::testing_repository::{
    ...
    fn unconflicting_merge() {
        ...
        let result =
            fluxgit_merge_commits(&test_repository.repository, b, c, "master", "feature")
                .unwrap();
    ...
    fn merging_conflicted_commit_with_unconflicted_incoming() {
        ...
        let result = fluxgit_merge_commits(
            &test_repository.repository,
            bc_result,
            d,
            "master",
    ...
    fn merging_conflicted_commit_with_conflicted_incoming() {
        ...
        let de_result =
            fluxgit_merge_commits(&test_repository.repository, d, e, "master", "feature")
                .unwrap();
