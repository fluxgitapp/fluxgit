...
// ClaudePermissionRequest { id: "toolu_01NYmPLovdj7sRdLxHT4AyQs", created_at: 2025-11-06T13:17:58.289023, updated_at: 2025-11-06T13:17:58.289028, tool_name: "Edit", input: Object {"file_path": String("/Users/calebowens/fluxgit-weird-shit/README.md"), "new_string": String("## Why FluxGit?\n\n<!-- Another example edit -->\nWe love Git. Our own [@schacon](https://github.com/schacon) has even published the [Pro Git](https://git-scm.com/book/en/v2) book."), "old_string": String("## Why FluxGit?\n\nWe love Git. Our own [@schacon](https://github.com/schacon) has even published the [Pro Git](https://git-scm.com/book/en/v2) book.")}, decision: None }
...
// ClaudePermissionRequest { id: "toolu_01B3WY7EaVhZoNnCZt5zXJ3a", created_at: 2025-11-06T13:21:27.041897, updated_at: 2025-11-06T13:21:27.041910, tool_name: "WebSearch", input: Object {"query": String("FluxGit virtual branches git client")}, decision: None }
