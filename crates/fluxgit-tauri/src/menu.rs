...
pub fn handle_event(webview: &WebviewWindow, event: &MenuEvent) {
    ...
    'open_link: {
        let result = match event.id().0.as_str() {
            "help/documentation" => open::that("https://docs.fluxgit.com"),
            "help/debugging-guide" => {
                open::that("https://docs.fluxgit.com/development/debugging")
            }
            "help/github" => open::that("https://github.com/fluxgitapp/fluxgit"),
            "help/release-notes" => {
                open::that("https://github.com/fluxgitapp/fluxgit/releases")
            }
            "help/report-issue" => {
                open::that("https://github.com/fluxgitapp/fluxgit/issues/new/choose")
            }
            "help/discord" => open::that("https://discord.com/invite/MmFkmaJ42D"),
            "help/youtube" => open::that("https://www.youtube.com/@fluxgitapp"),
            "help/bluesky" => open::that("https://bsky.app/profile/fluxgit.com"),
            "help/x" => open::that("https://x.com/fluxgit"),
            _ => break 'open_link,
        };
