...
pub struct User {
    ...
    /// The presence of a FluxGit access token is required for a valid user, but it's optional
...
impl User {
    pub(super) const ACCESS_TOKEN_HANDLE: &'static str = "fluxgit_access_token";
