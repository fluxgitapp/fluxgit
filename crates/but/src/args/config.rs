...
pub enum Subcommands {
    ...
    ///
    /// FluxGit uses metrics to help us know what is useful and improve it.
    /// Privacy policy: <https://fluxgit.com/privacy>
    ///
...
pub enum ForgeSubcommand {
    ...
    /// List authenticated forge accounts known to FluxGit.
    ///
