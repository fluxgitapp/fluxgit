...
pub enum Subcommands {
    /// Install the FluxGit CLI skill files for Coding agents
    ///
    ...
    ///
    /// ```text
    /// but skill install --path .claude/skills/fluxgit
    /// ```
    ///
    ...
    /// Check if installed FluxGit skills are up to date with the CLI version
    ///
