//! CLI ID generation and mapping for FluxGit entities.
//!
//! This module provides a system for generating short, human-friendly IDs for various FluxGit
...
/// A mapping from user-friendly CLI IDs to FluxGit entities.
pub struct IdMap {
...
/// A user-friendly CLI ID that identifies a FluxGit entity,
