...
use fluxgit_branch_actions::internal::PushResult;
use serde::Serialize;
...
pub fn handle(
    ...
    let gerrit_mode = {
        ...
        repo.git_settings()?.fluxgit_gerrit_mode.unwrap_or(false)
    };
...
fn handle_dry_run(
    ...
    let vb_state = fluxgit_stack::VirtualBranchesHandle::new(ctx.project_data_dir());
