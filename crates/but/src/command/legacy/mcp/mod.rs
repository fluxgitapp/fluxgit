...
impl Mcp {
    ...
    pub fn fluxgit_update_branches(
        &self,
        request: Parameters<FluxGitUpdateBranchesRequest>,
        ...
        let result = self.fluxgit_update_branches_inner(request.0.clone(), &client_info);
        ...
        event.insert_prop("endpoint", "fluxgit_update_branches");
    ...
    fn fluxgit_update_branches_inner(
        &self,
        request: FluxGitUpdateBranchesRequest,
...
pub struct FluxGitUpdateBranchesRequest {
...
impl ServerHandler for Mcp {
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            instructions: Some("FluxGit MCP server".into()),
            capabilities: ServerCapabilities::builder().enable_tools().build(),
            server_info: Implementation {
                name: "FluxGit MCP Server".into(),
                title: None,
                version: "1.0.0".into(),
                description: None,
                icons: None,
                website_url: Some("https://fluxgit.com".into()),
            },
