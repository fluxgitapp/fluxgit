...
"#]]);
    ...
    insta::assert_snapshot!(env.git_log()?, @r"
    *   9d5d9e5 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    |\  
    | * 9f9d5a6 (feature-branch) Add feature
    * | 9477ae7 (A) add A
    |/  
    * 0dc3733 (origin/main, origin/HEAD, main, fluxgit/target) add M
    ");
...
"#]]);
    ...
    insta::assert_snapshot!(env.git_log()?, @r"
    *   1bb7daf (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    |\  
...
"#]])
    ...
    insta::assert_snapshot!(env.git_log()?, @r"
    *-.   7044ae9 (HEAD -> fluxgit/workspace) FluxGit Workspace Commit
    |\ \  
