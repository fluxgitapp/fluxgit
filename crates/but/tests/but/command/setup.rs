...
FluxGit project setup complete!
...
The command-line interface for FluxGit
...
Learn more at https://docs.fluxgit.com/cli-overview
...
FluxGit project is already set up!
Target branch: origin/main
...
"#]]);
    ...
    let projects_file = env.app_data_dir().join("com.fluxgit.app/projects.json");
