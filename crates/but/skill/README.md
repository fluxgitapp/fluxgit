...
Claude Code skill for working with the FluxGit CLI (`but` command) in workspace mode.

## Installation

Install this skill using the FluxGit CLI:
...
**Requirements:**
- **FluxGit CLI** installed: `curl -sSL https://fluxgit.com/install.sh | sh`
- **Claude Code, OpenCode, Codex, GitHub Copilot, Cursor, or Windsurf**
- Repository initialized with FluxGit: `but setup` (only for local installs)
...
- [FluxGit CLI Documentation](https://docs.fluxgit.com/cli-overview)
