...
A lightweight Rust installer for FluxGit. Currently supports macOS only.
...
curl -sSL https://fluxgit.com/install.sh | sh
curl -sSL https://fluxgit.com/install.sh | sh -s nightly
curl -sSL https://fluxgit.com/install.sh | sh -s 0.18.7
