#![cfg(unix)]
//! FluxGit installer library
//!
//! This library provides functionality for installing FluxGit on Linux and macOS systems.
...
/// Runs the complete FluxGit installation process with a specific version.
///
...
/// Runs the complete FluxGit installation process.
///
/// Reads version from command-line arguments or FLUXGIT_VERSION environment variable.
...
fn run_installation_impl(config: InstallerConfig, interactive: bool) -> Result<()> {
    ...
    ui::println_empty();
    success(&format!(
        "✓ FluxGit CLI installation completed! ({}{})",
        channel
    ...
    if interactive {
        ...
        ui::println_empty();
        info("For more information, visit: https://docs.fluxgit.com");
    }
