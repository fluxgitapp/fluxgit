...
mod error {
    ...
    //! such that [context](fluxgit_error::error::Context) is handled correctly.
    //!
    ...
    //! and `message` fields.
    //!
    //! The values in these fields are controlled by attaching context, please [see the `error` docs](fluxgit_error::error))
    //! on how to do this.
