...
use but_core::branch;
use but_ctx::Context;
use fluxgit_branch_actions::{internal::PushResult, stack::CreateSeriesRequest};
...
pub fn update_branch_name(
    ...
    fluxgit_branch_actions::stack::update_branch_name(ctx, stack_id, branch_name, new_name)?;
    Ok(())
}
...
pub fn update_branch_pr_number(
    ...
    fluxgit_branch_actions::stack::update_branch_pr_number(
        ctx,
        stack_id,
        branch_name,
        pr_number,
